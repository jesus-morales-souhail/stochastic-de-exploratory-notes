...
The reason the physical probability is zero is not that I have not optimised the geometry enough.
It is that **the laws themselves shield the mechanism** against that abuse.

---

## Barrier 1 — Born rule ($P=\lvert \psi \rvert^2$)
...
**Why it fails in reality:** Superoscillatory designs that beat the naive scale in a small core dump almost all norm into side lobes. The demo in this repo shows the trend explicitly: as the “target” superoscillation strengthens, $E_{\mathrm{core}}$ collapses (e.g. toward $10^{-16}$ and smaller), not toward 1.
...
1. **Teaching material:** Fresnel + thin lens + Born; OU mean-reversion as a *structural* analogue of a restoring parameter.
