...
- Invent tesseract / superoscillation shortcuts for cosmology.
- Equate $\ln 4 \approx \omega_R$ (archived script) with a DESI discovery — the production QNM fit drives $\omega_R\to 0$.
- Claim slip will “save” visibility without an amplification model.
- Build home-made Boltzmann codes as the first move (Option 1).
...
These notes are pedagogical hygiene around that point. The actual residual claims live in the science repos, not here.
