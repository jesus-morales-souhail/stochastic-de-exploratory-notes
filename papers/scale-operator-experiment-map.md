...
Wrong scale **or** wrong operator ⇒ a null result that **does not** falsify the deep premise; it only falsifies “this effect is large here.”

I use that rule for everything below.

---

## 1. Closed result: car + drone at 120 km/h + pupil diffraction
...
**One-line moral:** local EM + inertial physics **shield** the experiment from cosmology — the same *kind* of “wrong question” as asking BAO for unamplified Planck-scale isotropic noise.

---

## 2. Experiment matrix: other scales, correct operators

### 2.1 Cosmology / vacuum (this repository’s broader programme)
...
| SDiff “gap” (anisotropic stress) | Isotropic BAO residual only | RSD + weak lensing / CMB lensing | Slip $\gamma=\Phi/\Psi$ or $\mu,\Sigma$ | **Option 0:** Maus+ $\gamma=1.17\pm 0.11$ (GR$=1$); $\lvert \eta-1 \rvert\sim 10^{-4}$ still below reach without amplification |
...
| Spacetime discreteness (premise, not shield) | Gravity-only channels if shield applies | Astrophysical baselines, high-$E$ photons | Energy-dependent time of flight (GRB / $\gamma$-ray), etc. | Literature-driven; not BAO residual |
...
| Cosmic expansion with light | Pupil in car | Gpc path, $z\sim 0.1\text{–}2$ | Redshift, BAO $D_M,D_H$, SN $\mu(z)$ | DESI / Euclid (main science repos) |
...
1. Car–drone–pupil at 120 km/h → **wrong scale / wrong operator** for expansion and for “4D diffraction.”
