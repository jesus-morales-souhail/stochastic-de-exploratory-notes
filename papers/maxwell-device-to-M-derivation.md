...
$$
(P_d u)(\mathbf r'_\perp)=\frac{k}{2\pi i d}\int d^2r_\perp e^{i k|\mathbf r'_\perp-\mathbf r_\perp|^2/(2d)} u(\mathbf r_\perp).
$$
...
$$
 M_{\rm device}=P_{d_n} L_{\Phi_{n-1}}\cdots P_{d_2} L_{\Phi_1} P_{d_1} }
$$
...
$$
u_{\rm out}(\mathbf r'_\perp)=\frac{1}{i\lambda B}\int d^2r_\perp \exp\!\Big[\frac{i}{2B}\big(A|\mathbf r_\perp|^2-2\mathbf r_\perp\!\cdot\!\mathbf r'_\perp+D|\mathbf r'_\perp|^2\big)\Big]u_{\rm in}.
$$
